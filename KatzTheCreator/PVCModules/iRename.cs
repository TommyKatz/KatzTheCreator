...
{
    public class iRename : ModuleBase<SocketCommandContext>{
        [Command("irename")]
        public async Task ChangePVCName([Remainder] string newPvcName){
            ...
            if (permCheck != 0){
                ...
                await rUser.VoiceChannel.ModifyAsync(x => { x.Name = $"{newPvcName}"; });
            }
